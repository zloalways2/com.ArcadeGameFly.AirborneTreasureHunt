...
namespace ZeroSDK.UIBuilder.Core.UIElements
{
    ...
    public class kiujyhtgrfedw : MonoBehaviour
    {
        ...
        public void wqerfegtrhytn()
        {
            ...
            {
                orgpjrehpojrehpero(false, false);
            }
        }
        ...
        public void oprgjerpojreopgj(bool wreegtrhfng = false, bool rwregtfhn = true, bool erwfregtrgnh = true)
        {
            if (rwregtfhn)
                hytgrfedw?.Invoke();
        ...
        public void orgpjrehpojrehpero(bool startCallback = true, bool endCallback = true)
        {
            if (startCallback)
        ...
        protected virtual void ewrgehtrnthgew()
        {
        }


        protected virtual void pijerhpjrehperjh()
        {
        }
        ...
        protected virtual void Reset()
        {
            ...
            if (prgojerhpojerhpjer.ewregtrh.Config != null)
            {
                rwegtrhytnh();
            }
        }
